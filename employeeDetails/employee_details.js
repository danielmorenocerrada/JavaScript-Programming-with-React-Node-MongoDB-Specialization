const employees = [
    { id: 1, name: 'John Doe', age: 30, department: 'IT', salary: 50000, specialization: 'Full stack' },
    { id: 2, name: 'Alice Smith', age: 28, department: 'HR', salary: 45000, specialization: 'Recruiting' },
    { id: 3, name: 'Bob Johnson', age: 35, department: 'Finance', salary: 60000, specialization: 'Budgets' },
...
function findEmployeeById(employeeId) {
 ...
 function findEmployeeBySpecialization(employeeSpecialization) {
    const foundEmployee = employees.find(employe => employe.specialization === employeeSpecialization);
    if (foundEmployee) {
